# models_dependencies/extractors/fhir_resources/encounter_satusehat.py
...
def fetch_encounter_satusehat(client: FrappeClient, start=None, end=None) -> list[dict]:
    ...
    return fetch_bulk(client, settings.encounter_satusehat_endpoint, start=start, end=end)
