MODEL (
  name bronze.tabObservation_SatuSehat,
...
SELECT
  ...
  vital_signs::VARCHAR AS vital_signs,
  ...
  validation_status::VARCHAR AS validation_status,
  satusehat_ids::VARCHAR AS satusehat_ids,
...
FROM frappe_bridge.bridge.tabobservation_satusehat
