MODEL (
  name bronze.tabMedicationStatement_SatuSehat,
...
SELECT
  ...
  medication_code::VARCHAR AS medication_code,
  medication_display::VARCHAR AS medication_display,
  date_asserted::TIMESTAMP AS date_asserted,
...
FROM frappe_bridge.bridge.tabmedicationstatement_satusehat
