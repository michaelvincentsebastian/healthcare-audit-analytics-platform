MODEL (
  name bronze.tabEpisodeOfCare_SatuSehat,
...
SELECT
  ...
  type_code::VARCHAR AS type_code,
  type_display::VARCHAR AS type_display,
...
FROM frappe_bridge.bridge.tabepisodeofcare_satusehat
