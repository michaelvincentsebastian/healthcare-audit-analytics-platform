MODEL (
  name bronze.tabProcedure_SatuSehat,
...
SELECT
  ...
  clinical_procedure::VARCHAR AS clinical_procedure,
  ...
  procedure_display::VARCHAR AS procedure_display,
...
FROM frappe_bridge.bridge.tabprocedure_satusehat
