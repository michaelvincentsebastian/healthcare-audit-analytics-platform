MODEL (
  name bronze.tabServiceRequest_SatuSehat,
...
SELECT
  ...
  loinc_code::VARCHAR AS loinc_code,
  loinc_display::VARCHAR AS loinc_display,
  request_text::VARCHAR AS request_text,
...
FROM frappe_bridge.bridge.tabservicerequest_satusehat
