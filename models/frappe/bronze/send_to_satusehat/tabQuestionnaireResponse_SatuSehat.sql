MODEL (
  name bronze.tabQuestionnaireResponse_SatuSehat,
...
SELECT
  ...
  questionnaire_url::VARCHAR AS questionnaire_url,
  authored_datetime::TIMESTAMP AS authored_datetime,
  keluhan_utama::VARCHAR AS keluhan_utama,
  riwayat_alergi::INTEGER AS riwayat_alergi,
...
FROM frappe_bridge.bridge.tabquestionnaireresponse_satusehat
