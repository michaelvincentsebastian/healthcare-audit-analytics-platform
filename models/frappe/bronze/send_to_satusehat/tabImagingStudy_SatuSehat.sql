MODEL (
  name bronze.tabImagingStudy_SatuSehat,
...
SELECT
  ...
  satusehat_servicerequest_id::VARCHAR AS satusehat_servicerequest_id,
  modality_code::VARCHAR AS modality_code,
  modality_display::VARCHAR AS modality_display,
  dicom_uid::VARCHAR AS dicom_uid,
...
FROM frappe_bridge.bridge.tabimagingstudy_satusehat
