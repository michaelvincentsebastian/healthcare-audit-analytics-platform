MODEL (
  name bronze.tabImmunization_SatuSehat,
...
SELECT
  ...
  vaccine_code::VARCHAR AS vaccine_code,
  vaccine_display::VARCHAR AS vaccine_display,
  occurrence_datetime::TIMESTAMP AS occurrence_datetime,
  lot_number::VARCHAR AS lot_number,
  expiration_date::DATE AS expiration_date,
  dose_number::INTEGER AS dose_number,
...
FROM frappe_bridge.bridge.tabimmunization_satusehat
