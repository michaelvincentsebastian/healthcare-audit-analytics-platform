MODEL (
  name bronze.tabSpecimen_SatuSehat,
...
SELECT
  ...
  specimen_identifier::VARCHAR AS specimen_identifier,
  specimen_code::VARCHAR AS specimen_code,
  specimen_display::VARCHAR AS specimen_display,
  collected_datetime::TIMESTAMP AS collected_datetime,
...
FROM frappe_bridge.bridge.tabspecimen_satusehat
